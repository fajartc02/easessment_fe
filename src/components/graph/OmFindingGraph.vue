        ...
        <div v-if="cond == 'default'">
          <div class="row">
            ...
            <div style="height: 300px" class="col-md-10 pt-2 pb-4 d-flex horizontal-scrollable">
              ...
              <div class="col-2 m-2" v-else v-for="detailGraph in getOmGraphs" :key="detailGraph.id">
...
import { GET_OM_GRAPH } from '@/store/modules/graph.module'
...
export default {
  ...
  computed: {
    ...mapGetters(['getLinesOpts', 'getOmGraphs', 'getGroupsOpts']),
  },
  methods: {
    clickHandler(event, chartContext, config) {
      console.log(event)
      ...
      if (config.seriesIndex != -1) {
        ...
        this.$router.push(
          `/om/temuan?cm_judg=${cm_judg}&line_id=${this.selectedLineID?.line_id
