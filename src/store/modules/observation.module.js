...
export const SAVE_OBSERVATION_CATEGORY_V2 = "saveObservationCategoryV2";
export const UPDATE_OBSERVATION_CATEGORY = "updateObservationCategory"
...
const actions = {
  ...
  [SAVE_OBSERVATION_CATEGORY_V2]({ commit } = null, data) {
    ApiService.setHeader()
    return new Promise((resolve, reject) => {
      ApiService.post('operational/observation/single-check-category-v2', data)
        .then((result) => {
          console.log(result);
          console.log(commit);
          resolve(true)
  ...
  [UPDATE_OBSERVATION_CATEGORY]({ commit } = null, data) {
    ApiService.setHeader()
    const obs_result_id = data?.obs_result_id
    delete data.obs_result_id
    return new Promise((resolve, reject) => {
      ApiService.put(`operational/observation/single-check-category/${obs_result_id}`, data)
        .then((result) => {
          console.log(result);
          console.log(commit);
          resolve(true)
