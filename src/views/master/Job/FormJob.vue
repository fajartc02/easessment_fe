    ...
    <div class="card-body text-center">
      ...
      <CInputGroup class="mb-3">
        ...
        <CFormSelect v-model="form.job_type_id">
          ...
          <option v-for="jobType in getJobTypeOptsWithoutAll" :key="jobType.id" :value="jobType.id">{{ jobType.text }}
          </option>
        </CFormSelect>
      </CInputGroup>
      <CInputGroup class="mb-3">
      ...
      <CInputGroup class="mb-3">
        <CInputGroupText>Std. Time</CInputGroupText>
        <CFormInput type="number" v-model="form.cycle_time" />
      </CInputGroup>
    </div>
