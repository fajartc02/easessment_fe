            ...
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        ...
                        <input type="date" class="form-control" v-model="selectedFilterStartDate"
                            @change="addFilter()" />
                    </div>
                    <div class="col">
                        ...
                        <div style="height: 300px" class="col-md-10 pt-2 pb-4 d-flex horizontal-scrollable">
                            ...
                            <div class="col-2 m-2" v-else v-for="detailGraph in get4SGraphs" :key="detailGraph.id">
                                <div class="w-100 h-100 rounded">
                                    <apexchart type="bar" :options="options" :series="detailGraph.chartData"
                                        height="100%" @click="(event, chartContext, config) => {
                    ...
                    <div class="row">
                        ...
                        <div style="height: 300px" class="col-md-10 pt-2 pb-4 d-flex horizontal-scrollable">
                            ...
                            <div class="col-2 m-2" v-else v-for="detailGraph in get4SGraphs" :key="detailGraph.id">
                                <div class="w-100 h-100 rounded">
                                    <apexchart type="bar" :options="options" :series="detailGraph.chartData"
                                        height="100%" @click="clickHandler"></apexchart>
                                </div>
