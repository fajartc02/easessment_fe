            ...
            <CAccordionBody>
              <div>
                ...
                <div class="mb-2">
                  ...
                  <VueMultiselect v-model="memberVoiceData.line_id" :options="lineData" placeholder=""
                ...
                <div class="mb-2">
                  ...
                  <VueMultiselect v-model="memberVoiceData.mv_pic_id" :options="picData" :custom-label="customPicOptions">
                  </VueMultiselect>
                </div>
                <div class="mb-2">
