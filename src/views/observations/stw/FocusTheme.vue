  ...
  <div>
    <div class="card mb-3">
      ...
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5>Fokus Tema</h5>
        <button class="btn btn-info text-white" @click="; (addFocusThemeModal = true), mapUsersData()">
          Add fokus tema
        </button>
      </div>
      <div>
            ...
            <CAccordionBody>
              <div>
                ...
                <div class="mb-2">
                  ...
                  <input type="text" class="form-control" v-model="focusThemeData.ft_pillar" />
                </div>
                <div class="mb-2">
            ...
            <!-- <CAccordionBody>
              <div>
                ...
                <div class="mb-2">
                  ...
                  <div class="row">
                    <div class="col">
                      <input type="text" disabled class="form-control" :value="getLineName(findingsData.ft_line_id)">
                    </div>
                    <div class="col">
                      <VueMultiselect v-model="selectedLineID" :options="lineData"
                        :custom-label="customLineFilterOptions">
